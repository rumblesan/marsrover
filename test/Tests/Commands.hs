...
commandTests :: Test
commandTests =
  testGroup "Command Tests" [testCase "Command can be parsed" test_commandParse]
...
test_commandParse =
  ...
  in do assertEqual
          "Forward Command can be parsed"
          (Just MoveForward)
          (readCommand 'F')
        assertEqual
          "Left Command can be parsed"
          (Just TurnLeft)
          (readCommand 'L')
        assertEqual
          "Right Command can be parsed"
          (Just TurnRight)
          (readCommand 'R')
